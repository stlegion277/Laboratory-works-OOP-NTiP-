...
//исправил(давно)
//TODO: Ќет, пробелы между функци€ми...
//исправил
namespace Lab2
{
	...
	double MakeCalculation(int value1, int value2)
	{
		...
		case '+':
			return value1 + value2;
			//TODO //исправил //TODO: „то исправили? break так и остались сто€ть...//теперь точно исправил!!
		case '*':
			return value1 * value2;
		case '/':
			return value1 / value2;
		...
		while (true)
		{
			...
			switch (m)
			{
				...
				case 9:
					...
					GlobalMultiplyThree();
					GlobalEqualsOne();
					break;//TODO: ‘орматирование!//исправил(скобочки)
